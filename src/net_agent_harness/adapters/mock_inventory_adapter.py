        ...
        DeviceInfo(
            ...
            interfaces=[
                InterfaceInfo(
                    ...
                    native_vlan=1,
                    allowed_vlans_mode=AllowedVlansMode.ALL,
                    vlan_ids=[],  # empty when "all"
                ),
                InterfaceInfo(
                    name="mge-0/0/2",
                    description="AP",
        ...
        DeviceInfo(
            ...
            interfaces=[
                ...
                InterfaceInfo(
                    ...
                    type=InterfaceType.SWITCHPORT,
                    mode=SwitchportMode.TRUNK,
                    stp=SpanningTreeMode.NONE, # firewall does not partipate in spanning-tree
                    native_vlan=1,
                    allowed_vlans_mode=AllowedVlansMode.ALL,
                    vlan_ids=[],  # empty when "all" empty when "all"
                ),
            ],
            vlans=[
                VlanInfo(
